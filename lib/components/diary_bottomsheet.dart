...
class DiaryModalBottomSheetRoute<T> extends PopupRoute<T> {
...
class _GetModalBottomSheet<T> extends StatefulWidget {
  ...
  final bool isPersistent;
  final DiaryModalBottomSheetRoute<T>? route;
  final bool isScrollControlled;
  final Color? backgroundColor;
  final double? elevation;
  final ShapeBorder? shape;
...
class _GetModalBottomSheetLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return BoxConstraints(
      minWidth: constraints.maxWidth - paddingSize * 2,
      maxWidth: constraints.maxWidth - paddingSize * 2,
      minHeight: 0.0,
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    return Offset(0.0 + paddingSize, size.height - childSize.height * progress);
  }
