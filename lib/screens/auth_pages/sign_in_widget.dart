              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(
                        color: DiaryTheme.loginGradientStart,
                        offset: Offset(1.0, 6.0),
                        blurRadius: 20.0,
                      ),
                      BoxShadow(
                        color: DiaryTheme.loginGradientEnd,
                        offset: Offset(1.0, 6.0),
                        blurRadius: 20.0,
                      ),
                    ],
                    gradient: LinearGradient(
                        colors: <Color>[
                          DiaryTheme.loginGradientEnd,
                          DiaryTheme.loginGradientStart
                        ],
                  ...
                  child: Visibility(
                    ...
                    child: MaterialButton(
                      ...
                      splashColor: DiaryTheme.loginGradientEnd,
                      child: const Padding(
